class Game {
  ...
  showLife() {
    push();
    image(lifeImage, width / 2 - 50, height - player.positionY - 250, 20, 20);
    fill("white");
    rect(width / 2 - 50, height - player.positionY - 250, 185, 20);
    fill("#f50057");
    rect(width / 2 - 50, height - player.positionY - 250, player.life, 20);
    noStroke();
    pop();
  }
  ...
  showFuelBar() {
    push();
    image(fuelImage, width / 2 - 50, height - player.positionY - 200, 20, 20);
    fill("white");
    rect(width / 2 - 50, height - player.positionY - 200, 185, 20);
    fill("#ffc400");
    rect(width / 2 - 50, height - player.positionY - 200, player.fuel, 20);
    noStroke();
    pop();
  }
  ...
  gameOver() {
    swal({
      title: `Fin del juego GANASTE SIUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUUU`,
      text: "¡Ups perdiste la carrera CARNAL TU GASOLINA SE acabo!",
      imageUrl:
